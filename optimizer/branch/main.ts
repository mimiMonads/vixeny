...
export default (o?: specialOptions) => (path: string) => (input: BranchOptions | BranchOptions[]): ResponseResponse =>
  (
    ar =>
      (
        table => 
        ...
        table(false)( o ? {...o, branch: true} : {branch: true})(path)(ar) as ({name:string,f:  (r:Request) => any  | Promise<any>})[]
      )
  )(
