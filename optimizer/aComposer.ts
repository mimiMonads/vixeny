          ...
          (
            ...
            (mutable =>
              [
                ...
                { name: "date", value: f.options?.setDate ? f.options.setDate :"Date.now()", type: 0 },
                { name: "randomNumber", value: f.options?.setRandomNumber ? f.options.setRandomNumber : "Math.random()", type: 0 },
                { name: "hash", value: f.options?.setHash ? f.options.setHash: "crypto.randomUUID()", type: 0 },
