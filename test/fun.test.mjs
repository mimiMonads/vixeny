          ...
          async (f) =>
            describe(
              [
                ...
                await (f(new Request("http://localhost:8080/hello_world")))
                  .text(),
                await (f(new Request("http://localhost:8080/random_number")))
                  .text(),
                await (f(
                  new Request("http://localhost:8080/plus_1", {
                    method: "POST",
                  }),
                )).text(),
                await (f(
                  new Request("http://localhost:8080/minus_1", {
                    method: "POST",
                  }),
                )).text(),
              ],
          ...
          async (f) =>
            describe(
              [
                ...
                await (f(
                  new Request("http://localhost:8080/hello/***/*/*/*/*"),
                )).text(),
                await (f(
                  new Request("http://localhost:8080/hello/nested/*/*/*/*"),
                )).text(),
              ],
            ).toEqual(
              [
          ...
          async (f) =>
            describe(
              [
                ...
                (await (f(
                  new Request("http://localhost:8080/static/fun.test.ts"),
                ))).status,
              ],
            ).toEqual(
              [
