...
type Solver =  (o?: FunRouterOptions<any>) => (atlas: Atlas1) => (r: Request) => number


export default ((o?: FunRouterOptions<any>) => (atlas: Atlas1) => (
  (me) => (
    (solve) => (atlas[4][0] as Atlas1[0]).length === 0
      ? (r: Request) => solve[me(r.method)](r.url)
      : (
        (m1) => (
          (solve1) => (r: Request) => solve[me(r.method)](r.url) ?? solve1[m1(r.method)](r.url)
        )(
          solver({
            ...o,
            stateFlags: {
